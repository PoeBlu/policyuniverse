...
statement09_wildcard = dict(
    ...
    Action=["rds:*"],
    Resource="*",
    Condition={"StringLike": {"AWS:SourceOwner": "*"}},
)
...
statement12 = dict(
    ...
    Condition={
        ...
        "StringLike": {"AWS:userid": "AROAI1111111111111111:*"},
        "ARNLike": {"AWS:SourceArn": "arn:aws:iam::012345678910:role/Admin"},
        "IpAddressIfExists": {
            "AWS:SourceIP": ["123.45.67.89", "10.0.7.0/24", "172.16.0.0/16"]
        },
    },
)
...
statement13 = dict(
    ...
    Resource="*",
    Condition={
        "StringNotLike": {"AWS:userid": "AROAI1111111111111111:*"},
        "ARNLike": {"AWS:SourceArn": "arn:aws:iam::012345678910:role/Admin"},
    },
)
...
statement15 = dict(
    ...
    Action=["rds:*"],
    Resource="*",
    Condition={"StringNotLike": {"AWS:userid": "AROAI1111111111111111:*"}},
)
...
statement18 = dict(
    ...
    Action=["rds:*"],
    Resource="*",
    Condition={"ARNLike": {"AWS:SourceArn": "arn:aws:iam::*:role/Admin"}},
)
...
statement19 = dict(
    ...
    Action=["rds:*"],
    Resource="*",
    Condition={"StringLike": {"AWS:SourceArn": "arn:aws:iam::*"}},
)
...
statement22 = dict(
    ...
    Action=["rds:*"],
    Resource="*",
    Condition={"StringEquals": {"AWS:SourceArn": "arn:aws:iam:::user/MyUser"}},
)
...
class StatementTestCase(unittest.TestCase):
    ...
    def test_statement_summary(self):
        ...
        self.assertEqual(
            statement.action_summary(), {"ec2": {"Write"}, "iam": {"Permissions"}}
        )

        statement = Statement(statement26)
        self.assertEqual(statement.action_summary(), {"iam": {"Permissions", "List"}})
